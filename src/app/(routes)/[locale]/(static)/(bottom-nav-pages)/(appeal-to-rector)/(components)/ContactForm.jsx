...
const ContactForm = ({ locale, type = 'rector' }) => {
  ...
  const labels = {
    az: {
      ...
      intro: type === 'rector' 
        ? 'Hörmətli Tələbələr, Əziz Rektora hər hansı bir sualınız, təklifiniz və ya şikayətiniz varsa, müraciətinizi təqdim edə bilərsiniz. Xahiş oluruq, müraciət formasındakı bütün tələb olunan sahələrin tam olaraq doldurulmasını və mətlərinizin aydın şəkildə ifadə etməyiniz təmin edin.'
