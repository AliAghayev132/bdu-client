...
export default async function RektoraMuracietPage({ params }) {
  const { locale } = await params;
  return <PageContent locale={locale} slug="rektora-muraciet" />;
}
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${title}`,
    description,
    keywords: 'BDU, Bakı Dövlət Universiteti, rektor, müraciət, appeal, contact',
