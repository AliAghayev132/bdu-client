    ...
    <>
      {announcements.map((item) => (
        <div key={item.id} className="min-w-[280px] w-[280px] flex-shrink-0">
          ...
          >
            {/* Date and Time */}
            <div className="flex items-center gap-2 text-xs text-[#B8956A] font-medium mb-3">
            ...
            {/* Title */}
            <h3 className="text-sm text-gray-700 group-hover:text-primary transition-colors leading-snug line-clamp-3 mb-3">
              {item.title}
            </h3>

            {/* ELAN Badge */}
            <div className="inline-flex items-center gap-1 text-xs text-[#B8956A] font-medium">
              <span>– ELAN</span>
            </div>
          </Link>
        </div>
