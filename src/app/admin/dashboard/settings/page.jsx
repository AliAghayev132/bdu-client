...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Parametrlər</h1>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button className="p-4 border-2 border-blue-600 rounded-lg bg-white">
                  <div className="w-full h-20 bg-gradient-to-br from-blue-50 to-white rounded mb-2"></div>
                  <p className="text-sm font-medium">İşıq</p>
                </button>
                <button className="p-4 border-2 border-gray-300 rounded-lg bg-white hover:border-blue-600 transition-colors">
                  <div className="w-full h-20 bg-gradient-to-br from-gray-800 to-gray-900 rounded mb-2"></div>
                  <p className="text-sm font-medium">Qaranlıq</p>
                </button>
              </div>
            </div>
          </div>
