...
// Use /admin/dashboard/events/create and /admin/dashboard/events/[id]/edit instead.

export default function EventsModal() {
  return null;
}

function _OriginalEventsModal({ isOpen, onClose, onSubmit, initialData = null, isLoading = false }) {
