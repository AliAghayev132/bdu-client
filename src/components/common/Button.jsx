...
const Button = ({ text, rounded = true, icon = null, weight = "normal", active=false, onClick = () => {} }) => {
  return (
    <button
      onClick={onClick}
      className={`laptop:text-base sm:text-sm mobile:text-xs text-[10px] mobile:px-6 px-4 py-2 flex items-center gap-2 text-center border border-primary text-primary
